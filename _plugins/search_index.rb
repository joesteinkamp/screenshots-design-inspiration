  ...
  module SearchIndex
    ...
    class << self
      ...
      def skip?(page)
        ...
        # Stubs generated by jekyll-redirect-from for moved URLs (the pre-split
        # /Mobile/* galleries). They carry no title, tags or body, so indexing
        # them just puts empty results in front of people.
        return true if page.data.is_a?(Hash) && page.data.key?('redirect')
        false
      end
